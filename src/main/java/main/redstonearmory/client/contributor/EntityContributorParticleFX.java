...
public class EntityContributorParticleFX extends EntityFX {

	// Oh look, BoP code!

	private int index;

	public EntityContributorParticleFX(World world, double x, double y, double z, IIcon particleIcon) {
		super(world, x, y, z, 0.0D, 0.0D, 0.0D);

		this.setParticleIcon(particleIcon);
