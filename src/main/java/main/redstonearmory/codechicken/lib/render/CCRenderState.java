...
import main.redstonearmory.codechicken.lib.colour.ColourRGBA;
import main.redstonearmory.codechicken.lib.lighting.LC;
import main.redstonearmory.codechicken.lib.lighting.LightMatrix;
import main.redstonearmory.codechicken.lib.util.Copyable;
import main.redstonearmory.codechicken.lib.vec.Rotation;
import main.redstonearmory.codechicken.lib.vec.Transformation;
...
public class CCRenderState
{
    ...
    public static void setBrightness(IBlockAccess world, int x, int y, int z) {
        setBrightness(Block.blocksList[world.getBlockId(x, y, z)].getMixedBrightnessForBlock(world, x, y, z));
    }
