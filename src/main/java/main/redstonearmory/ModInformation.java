...
public class ModInformation {
	...
	public static final String VERSION = "1.1pre7";
	public static final String GUIFACTORY = "main.redstonearmory.gui.ConfigGuiFactory";
	public static final String REQUIRED = "required-after:RedstoneArsenal;" + "required-after:ttCore;" + "after:ThermalFoundation;";
