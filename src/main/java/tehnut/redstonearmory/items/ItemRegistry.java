...
public class ItemRegistry {
    ...
    @Register(name = "ItemEnderiumArmor.Helm") public static Item armorEnderiumHelm = new ItemEnderiumArmor(0);
    @Register(name = "ItemEnderiumArmor.Chestplate") public static Item armorEnderiumChestplate = new ItemEnderiumArmor(1);
    @Register(name = "ItemEnderiumArmor.Leggings") public static Item armorEnderiumLeggings = new ItemEnderiumArmor(2);
    @Register(name = "ItemEnderiumArmor.Boots") public static Item armorEnderiumBoots = new ItemEnderiumArmor(3);

    @Register(name = "ItemPowersuit.Helm", enabled = "enableTestingEnviro") public static Item armorPowersuitHelm = new ItemPowersuit(0);
    @Register(name = "ItemPowersuit.Chestplate", enabled = "enableTestingEnviro") public static Item armorPowersuitChestplate = new ItemPowersuit(1);
    @Register(name = "ItemPowersuit.Leggings", enabled = "enableTestingEnviro") public static Item armorPowersuitLeggings = new ItemPowersuit(2);
    @Register(name = "ItemPowersuit.Boots", enabled = "enableTestingEnviro") public static Item armorPowersuitBoots = new ItemPowersuit(3);

    @Register(name = "ItemLumiumArmor.Helm") public static Item armorLumiumHelm = new ItemLumiumArmor(0);
    @Register(name = "ItemLumiumArmor.Chestplate") public static Item armorLumiumChestplate = new ItemLumiumArmor(1);
    @Register(name = "ItemLumiumArmor.Leggings") public static Item armorLumiumLeggings = new ItemLumiumArmor(2);
    @Register(name = "ItemLumiumArmor.Boots") public static Item armorLumiumBoots = new ItemLumiumArmor(3);

    @Register(name = "ItemTuberousArmor.Helm") public static Item armorTuberousHelm = new ItemTuberousArmor(0);
    @Register(name = "ItemTuberousArmor.Chestplate") public static Item armorTuberousChestplate = new ItemTuberousArmor(1);
    @Register(name = "ItemTuberousArmor.Leggings") public static Item armorTuberousLeggings = new ItemTuberousArmor(2);
    @Register(name = "ItemTuberousArmor.Boots") public static Item armorTuberousBoots = new ItemTuberousArmor(3);

    @Register(name = "ItemRedstoneArmor.Boots") public static Item armorRedstoneBoots = new ItemRedstoneArmor(3);
}
