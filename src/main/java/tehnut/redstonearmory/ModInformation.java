...
public class ModInformation {
    ...
    public static final String REQUIRED = "required-after:RedstoneArsenal;" + "required-after:endercore;" + "required-after:ThermalFoundation;" + "required-after:ThermalExpansion;" + "after:Baubles";
