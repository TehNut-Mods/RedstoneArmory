...
public class ModInformation {
    ...
    public static final String GUIFACTORY = "tehnut.redstonearmory.gui.ConfigGuiFactory";
    public static final String REQUIRED = "required-after:RedstoneArsenal;" + "required-after:ttCore@[MC1.7.10-0.1.1-75,);" + "required-after:ThermalFoundation;" + "required-after:ThermalExpansion;";
