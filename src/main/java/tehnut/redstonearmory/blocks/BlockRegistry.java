...
public class BlockRegistry {
    ...
    @Register(enabled = "addNutsToys", itemBlock = ItemBlockRandomThings.class)
    public static Block randomBlocks = new BlockRandomThings(Material.rock);
    ...
    @Register(enabled = "enableTestingEnviro")
